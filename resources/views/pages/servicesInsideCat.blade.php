                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li>
                            <a href="#submenu3" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                                ...
                                <li>
                                    <a href="http://127.0.0.1:8000/services/3" class="nav-link px-0"> <span class="d-none d-sm-inline">Cleaning Homes</span> <i class="bi bi-chevron-right"></i></a>
                                </li>
                                <li>
                                    <a href="http://127.0.0.1:8000/services/6" class="nav-link px-0"> <span class="d-none d-sm-inline">Cleaning Cars</span> <i class="bi bi-chevron-right"></i></a>
                                </li>
                                <li>
                                    <a href="http://127.0.0.1:8000/services/9" class="nav-link px-0"> <span class="d-none d-sm-inline">Cleaning Villa</span> <i class="bi bi-chevron-right"></i></a>
                                </li>
                                <li>
                                    <a href="http://127.0.0.1:8000/services/10" class="nav-link px-0"> <span class="d-none d-sm-inline">Cleaning Motorcycle</span> <i class="bi bi-chevron-right"></i></a>
                                </li>
